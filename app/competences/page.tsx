...
export default function Competences() {
    ...
    return (
        <div className="flex flex-col flex-1 w-full items-center gap-10">
            <h1 className="text-5xl font-bold">Compétences</h1>
            <BigList items={[hardSkillCard, softSkillCard]}/>
            <h1 className="text-5xl font-bold">Langages / Technologies</h1>
            <div className="flex flex-col items-baseline bg-slate-900 rounded-lg p-4 w-4/5 shadow-xl shadow-slate-800">
