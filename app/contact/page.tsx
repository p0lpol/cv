...
export default function Page() {
    ...
    const LinkedIn = (
        ...
        />
    return (
        <main className="bg-linear-to-b from-green-400 via-green-900 to-black pt-32 pb-16">
            <div className="flex flex-col flex-1 w-9/10 items-center gap-4 bg-slate-900 rounded-2xl p-8 min-h-dvh my-8 relative left-1/20 right-1/20">
