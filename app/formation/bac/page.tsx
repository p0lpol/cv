            ...
            <BigList items={[
                {
                    ...
                    <div className="flex flex-col justify-evenly items-center h-50">
                        <p className="text-xl">Compétences clés</p>
                ...
                },
                {
                    ...
                    image: "/jj_up.jpeg",
                    description:
                        <div className="flex flex-col justify-evenly items-center h-70 gap-4">
                            <p>
                            ...
                            <iframe
                                ...
                                width="400" height="200" allowFullScreen={true} loading="lazy"
